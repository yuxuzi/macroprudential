...
plupload.Uploader = function(settings) {
	...
	plupload.extend(this, {
		...
		init : function() {
          ...
          // WARNING: Dropbox specific logic here! 507 is returned by our
          // blockservers to indicate the user is over quota. In this case the
          // chunk upload should not be retried, and the error event should be
          // immediately fired so the Dropbox file uploader is notified.
					if (!(xhr.status === 507) && retries-- > 0) {
